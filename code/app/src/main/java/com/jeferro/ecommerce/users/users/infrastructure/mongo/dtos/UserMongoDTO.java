package com.jeferro.ecommerce.users.users.infrastructure.mongo.dtos;
...
public class UserMongoDTO extends AuditedMongoDTO {
  ...
  public UserMongoDTO(String id, String encodedPassword, Set<String> roles, Long version, MetadataMongoDTO metadata) {
