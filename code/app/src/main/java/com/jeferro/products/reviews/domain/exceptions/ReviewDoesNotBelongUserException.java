package com.jeferro.products.reviews.domain.exceptions;

import static com.jeferro.products.shared.domain.exceptions.ProductExceptionCodes.REVIEW_NOT_ALLOWED;
